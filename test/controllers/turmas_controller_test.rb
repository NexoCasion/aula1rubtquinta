...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { fim: @turma.fim, horas: @turma.horas, inico: @turma.inico, nome: @turma.nome } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { fim: @turma.fim, horas: @turma.horas, inico: @turma.inico, nome: @turma.nome } }
