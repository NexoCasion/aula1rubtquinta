...
class SeriadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seriado" do
    assert_difference("Seriado.count") do
      post seriados_url, params: { seriado: { dataDeLançamento: @seriado.dataDeLançamento, description: @seriado.description, direto: @seriado.direto, episodios: @seriado.episodios, nome: @seriado.nome } }
    end
  ...
  test "should update seriado" do
    patch seriado_url(@seriado), params: { seriado: { dataDeLançamento: @seriado.dataDeLançamento, description: @seriado.description, direto: @seriado.direto, episodios: @seriado.episodios, nome: @seriado.nome } }
